...
# Input stock ticker and period
stocks = input('The Name Of Stock: ')
stock = yf.Ticker(stocks)

# Input number of days or period as accepted by yfinance
num_days = input("Number of Days (e.g., '1d', '5d', '1mo', '3mo'): ")

# get historical market data
df = stock.history(period=num_days)
